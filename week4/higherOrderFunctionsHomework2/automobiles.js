...
let _TYPE_ENUM = Object.freeze({"roadster":5, "pickup":4, "suv":3, "wagon":2});
...
{
  let retVal = true; 
  let typeVal1 = _TYPE_ENUM[auto1.type.toString().toLowerCase()]; 
  let typeVal2 = _TYPE_ENUM[auto2.type.toString().toLowerCase()]; 
  if( typeof(typeVal1) == 'undefined' || typeVal2 > typeVal1)
    retVal = false;
  return retVal;
}
...
automobiles.forEach(function(a){a.logMe(false);});
